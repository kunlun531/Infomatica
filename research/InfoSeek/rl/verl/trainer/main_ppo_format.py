...
def _select_rm_score_fn(data_source):
    if data_source in ['nq', 'triviaqa', 'popqa', 'hotpotqa', '2wikimultihopqa', 'musique', 'bamboogle', 'wikihard', 'browsecomp', 'webwalker_en', 'GAIA_1', 'GAIA_2', 'GAIA_3']:
...
class RewardManager():
    ...
    def __init__(self, tokenizer, num_examine, structure_format_score=0., final_format_score=0., retrieval_score=0., format_score=0., process_reward=False) -> None:
    ...
    def __call__(self, data: DataProto):
        ...
        for i in range(len(data)):
            ...
            score, process_score = compute_score_fn(solution_str=sequences_str, ground_truth=ground_truth, 
            ...
            process_reward_tensor[i, valid_response_length - 1] = process_score
        ...
        return reward_tensor, process_reward_tensor
